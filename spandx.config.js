...
defaults.routes['/insights/remediations'] = { host: `http://${localhost}:${port}` };
defaults.routes['/beta/apps/remediations'] = { host: `http://${localhost}:${port}` };
defaults.routes['/beta/insights/remediations'] = { host: `http://${localhost}:${port}` };
